...
It leverages [Sqitch](https://sqitch.org/) adding 
[shell commands](/COMMANDS.md) for creating common migrations. For example, to create a schema named `api` you'd use `ply create-schema api`.
